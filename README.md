...
A pre-built docker container with all required dependencies will be made available, but the below dependencies should all be straightforward to install. Scripts will run on OS X and other Unix-based systems.
